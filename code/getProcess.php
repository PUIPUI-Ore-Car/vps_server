<?php
  ...
  function getAllData() {
    ...
    $data = array('method' => strtolower($_SERVER['REQUEST_METHOD']), 'command' => 'AllDataFetch','odo' => $odo, 'temp' => $tempData["temp"], 'humidity' => $tempData["humidity"], 'ssid' => $network["ssid"], 'ipAddr' => $network["ipAddr"], 'time' => $tempData["time"]);
